...
class ExpenseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $seedExpenses = [
            ...
            ['title' => 'Pago contribuciones primer semestre', 'category' => 'Impuestos', 'amount' => 1550000, 'days_ago' => 45, 'due_in' => 15, 'distribution' => ExpenseDistributionType::ProportionalByHectares, 'status' => ExpenseStatus::Registered, 'funded_amount' => 0],
            ...
            ['title' => 'Pago patente municipal', 'category' => 'Impuestos', 'amount' => 460000, 'days_ago' => 28, 'due_in' => 7, 'distribution' => ExpenseDistributionType::EqualByPartner, 'status' => ExpenseStatus::Cancelled],
        ];
