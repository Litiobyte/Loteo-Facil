...
class CollectionApplicationServiceTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        parent::setUp();
        $this->service = new CollectionApplicationService;
    ...
    public function test_exact_payment_covers_one_charge_completely(): void
    {
        ...
        // Act
        $allocations = $this->service->applyCollectionAutomatically($payment);
        ...
        $this->assertEquals(CollectionStatus::FullyApplied, $payment->status);
    }
    ...
    public function test_overpayment_generates_credit_balance(): void
    {
        ...
        $this->assertEquals(CollectionStatus::PartiallyApplied, $payment->status);
    }
    ...
    public function test_cannot_apply_payment_to_charge_from_different_propietario(): void
    {
        ...
        $this->service->applyCollectionManually($payment, [
    ...
    public function test_manual_application_works_correctly(): void
    {
        ...
        $allocations = $this->service->applyCollectionManually($payment, [
    ...
    public function test_reversal_restores_correct_states(): void
    {
        ...
        $this->assertEquals(CollectionStatus::PendingApplication, $payment->status);

        $this->assertDatabaseMissing('collection_allocations', ['id' => $allocation->id]);
    }
    ...
    public function test_cannot_apply_cancelled_payment(): void
    {
        ...
        $this->service->applyCollectionAutomatically($payment);
    }
    ...
    public function test_preview_automatic_allocation_does_not_save(): void
    {
        ...
        $this->assertEquals(0, CollectionAllocation::count());
        $charge1->refresh();
        $charge2->refresh();
    ...
    public function test_all_sums_always_balance_correctly(): void
    {
        ...
        $payment->refresh();
        $totalAllocated = CollectionAllocation::where('collection_id', $payment->id)->sum('amount');
