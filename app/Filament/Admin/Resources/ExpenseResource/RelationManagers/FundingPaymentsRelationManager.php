...
class FundingPaymentsRelationManager extends RelationManager
{
    protected static string $relationship = 'fundingPayments';

    protected static ?string $title = 'Pagos de gasto (egresos)';
