        ...
        return $table
            ->columns([
                ...
                TextColumn::make('charge.description')
                    ...
                    ->state(fn (CollectionAllocation $record): string => $record->charge?->description ?? "Cobro #{$record->partner_charge_id}")
                    ->wrap(),
            ...
            ->recordActions([
                Action::make('reverse_allocation')
                    ...
                    ->action(function (CollectionAllocation $record): void {
                        try {
                            app(CollectionApplicationService::class)->reverseAllocation($record);
